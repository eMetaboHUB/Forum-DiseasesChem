...
with open(os.path.join(path_to_dumps, update_f_name), "a") as update_f:
    ...
    update_f.write("ld_dir_all ('./dumps/" + os.path.join("Id_mapping", "Inter", "MetaNetX", MetaNetX_v, '') + "', '" + "*.ttl.gz" + "', '" + str(uri_MetaNetX_inter_eq) + "');\n")
    update_f.write("ld_dir_all ('./dumps/" + os.path.join("Id_mapping", "Inter", "MetaNetX", MetaNetX_v, '') + "', '" + "void.ttl" + "', '" + str(uri_MetaNetX_inter_eq) + "');\n")
    update_f.write("ld_dir_all ('./dumps/" + os.path.join("Id_mapping", "Intra", "MetaNetX", MetaNetX_v, '') + "', '" + "*.ttl.gz" + "', '" + str(uri_MetaNetX_intra_eq) + "');\n")
    update_f.write("ld_dir_all ('./dumps/" + os.path.join("Id_mapping", "Intra", "MetaNetX", MetaNetX_v, '') + "', '" + "void.ttl" + "', '" + str(uri_MetaNetX_intra_eq) + "');\n")
