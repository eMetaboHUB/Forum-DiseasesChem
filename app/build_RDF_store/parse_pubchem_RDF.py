...
path_to_CID_list = "/home/mxdelmas/Documents/Thèse/building_database/FORUM/metdiseasedatabase/additional_files/2020-05-29/all_linked_ids.txt"
all_CIDs = list()
with open(path_to_CID_list, "r") as f:
    for cid in f:
        all_CIDs.append(cid.rstrip())
...
parse_pubchem_RDF(input_ressource_directory = "/home/mxdelmas/Documents/Thèse/building_database/FORUM/metdiseasedatabase/docker-virtuoso/share/PubChem_Compound/compound/2020-04-24/",
                  all_ids = all_CIDs,
                  prefix = "compound:CID",
                  out_dir = "/home/mxdelmas/Documents/Thèse/building_database/FORUM/metdiseasedatabase/docker-virtuoso/share/PubChem_Compound/",
                  input_ressource_file = "/home/mxdelmas/Documents/Thèse/building_database/FORUM/metdiseasedatabase/docker-virtuoso/share/PubChem_Compound/compound/2020-04-24/void.ttl",
                  input_ressource_uri = rdflib.URIRef("http://database/ressources/PubChem/compound/2020-04-24"),
                  filtered_ressource_name = "CompoundFiltered",
                  input_ids_uri = rdflib.URIRef("http://database/ressources/PMID_CID/2020-05-29"),
                  isZipped = True,
                  namespace_dict = namespaces,
                  version = "PMID_CID_2020-05-29",
                  separator = '\t')
